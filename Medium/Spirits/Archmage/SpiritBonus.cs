...
namespace MediumClass.Medium.Spirits.Archmage
{
    class SpiritBonus
    {
        private static readonly string FeatName = "ArchmageSpiritBonus";
        private static readonly string DisplayName = "ArchmageSpiritBonus.Name";
        private static readonly string Description = "ArchmageSpiritBonus.Description";
        private static readonly ModLogger Logger = Logging.GetLogger(nameof(SpiritBonus));

        public static void ConfigureEnabled()
        {
            Logger.Log("Generating Archmage Spirit Bonus");
            BlueprintFeature SpiritBonus = FeatureConfigurator.New(FeatName, Guids.ArchmageSpiritBonus)
