...
namespace MediumClass.Medium.Spirits.Champion
{
    class SpiritBonus
    {
        private static readonly string FeatName = "ChampionSpiritBonus";
        private static readonly string DisplayName = "ChampionSpiritBonus.Name";
        private static readonly string Description = "ChampionSpiritBonus.Description";
        ...
        {
            Logger.Log("Generating Champion Spirit Bonus");
            BlueprintFeature SpiritBonus = FeatureConfigurator.New(FeatName, Guids.ChampionSpiritBonus)
